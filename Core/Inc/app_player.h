...
/* Shared player state (used by UI and audio tasks) */
...
extern volatile uint8_t skip_track;
extern volatile int8_t track_direction;
extern volatile uint8_t is_paused;
extern uint8_t force_ui_update;
extern uint8_t pending_resume;
